...
public class StringUtilTest {
    ...
    */
    @Test
    public void isLowerCaseTest() throws Exception {
    }

    /**
    *
    * Method: containsUppercase(string)
    */
    @Test
    public void containsUppercaseTest() throws Exception {
    }

    /**
    *
    * Method: containsLowercase(string)
    */
    @Test
    public void containsLowercaseTest() throws Exception {
    }
